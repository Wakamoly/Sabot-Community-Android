...
import com.lucidsoftworksllc.sabotcommunity.others.toast
...
class UploadProfilePhotoFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val uploadCoverView = inflater.inflate(R.layout.fragment_upload_profile_photo, container, false)
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                try {
                    ...
                    if (Build.VERSION.SDK_INT < 29){
                        ...
                        activity?.toast("Cannot display image cropped! (Android 10+ temporary issue, upload should work as usual.)")
                    }
    ...
    companion object {
        const val UPLOAD_URL = Constants.ROOT_URL + "uploadProfilePhoto.php"
    }
}