...
public class UploadCoverFragment extends Fragment {
    ...
    public static final String UPLOAD_URL = Constants.ROOT_URL+"uploadCoverProfile.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View uploadCoverView = inflater.inflate(R.layout.fragment_upload_cover, container, false);
