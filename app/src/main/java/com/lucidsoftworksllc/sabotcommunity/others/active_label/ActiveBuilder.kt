...
class ActiveBuilder {
    ...
    static fun createElements(type: ActiveType, from text: String, range: NSRange, filterPredicate: ActiveFilterPredicate?) -> [ElementTuple] {
        switch type {
    ...
    static fun createURLElements(from text: String, range: NSRange, maximumLength: Int?) -> ([ElementTuple], String) {
    ...
    @JvmStatic
    private fun createElements(text: String,
    type: ActiveType,
    range: NSRange,
    minLength: Int = 2,
