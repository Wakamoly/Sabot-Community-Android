...
public interface SocialView {
    ...
    /**
     * Returns regex that are responsible for finding clan and game <b>mentions</b>.
     * By default, the pattern are {@code *(\w+)}.
     */
    @NonNull
    Pattern getDoubleMentionPattern();
    ...
    /**
     * Modify regex that are responsible for finding <b>mentions</b>.
     *
     * @param pattern custom regex. When null, default pattern will be used.
     */
    ...
    /**
     * Modify regex that are responsible for finding clan and game <b>mentions</b>.
     *
     * @param pattern custom regex. When null, default pattern will be used.
     */
    void setDoubleMentionPattern(@Nullable Pattern pattern);
    ...
    /**
     * Returns true if clan and game <b>mentions</b> in this view are spanned.
     */
    boolean isDoubleMentionEnabled();
    ...
    /**
     * Determine whether this view should span clan and game <b>mentions</b>.
     *
     * @param enabled True when spanning should be enabled.
     */
    void setDoubleMentionEnabled(boolean enabled);
    ...
    /**
     * Returns color instance of clan and game <b>mentions</b>, default is color accent of current app theme.
     * Will still return corresponding color even when {@link #isMentionEnabled()} ()} is false.
     */
    @NonNull
    ColorStateList getDoubleMentionColors();
    ...
    /**
     * Sets clan and game <b>mentions</b> color instance.
     *
     * @param colors Colors state list instance.
     */
    void setDoubleMentionColors(@NonNull ColorStateList colors);
    ...
    /**
     * Returns color integer of clan and game <b>mentions</b>.
     *
     * @see #getMentionColors()
     */
    @ColorInt
    int getDoubleMentionColor();
    ...
    /**
     * Sets clan and game <b>mentions</b> color integer.
     *
     * @param color Color integer.
     * @see #setMentionColors(ColorStateList)
     */
    void setDoubleMentionColor(@ColorInt int color);
    ...
    /**
     * Registers a callback to be invoked when a clan or game <b>mention</b> is clicked.
     *
     * @param listener The callback that will run.
     */
    void setOnDoubleMentionClickListener(@Nullable OnClickListener listener);
    ...
    /**
     * Registers a text watcher to be invoked when a clan or game <b>mention</b> is modified.
     *
     * @param listener The callback that will run.
     */
    void setDoubleMentionTextChangedListener(@Nullable OnChangedListener listener);
    ...
    /**
     * Returns list of all clan and game <b>mentions</b> found in {@link TextView#getText()}.
     */
    @NonNull
    List<String> getDoubleMentions();
