...
class MessagesNetworkMapper : EntityMapper<MessagesNetworkEntity, MessagesDataModel> {
    ...
    override fun mapToEntity(domainModel: MessagesDataModel): MessagesNetworkEntity {
        return MessagesNetworkEntity(
                id = domainModel.id,
    ...
    fun mapFromEntityList(entities: List<MessagesNetworkEntity>): List<MessagesDataModel>{
